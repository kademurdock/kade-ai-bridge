...
function planPrompt(goal) {
  return [
    ...
    '  {"kind":"call","who":"<the business by name>","why":"<the ONE thing to ask them, in a sentence>"}',
    ...
    '      Put a research step BEFORE it so the number can be found; do not invent a number.',
